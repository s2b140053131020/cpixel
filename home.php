    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <button class="btn btn-success" id="get_start" filename="119-abc.csv">Start Process
                </button>
...
if($row['status']==1)
{?>
                            <td class="text-success">Done
                            </td>
                            <?php 
}
else{         
?>
                            <td class="red">InProgress
                            </td>
                            <?php
}
?>
...
<script>
    $(document).ready(function(e) {
        ...
        $('#get_start').click(function() {
            ...
            $('.statusMsg').html('');
            var fileName = $('#get_start').attr("filename");
            $('#pbar').show(100);
            $('#pbar .progress-bar').text("Processing For : "+fileName +"...")
